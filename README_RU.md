...
- [x] Кастомные монументы
  - Размещение своих монументов из RustEdit (`.map` или `.prefab`) на новых местах вместе с рельефом
  - Перенос или выравнивание рельефа, копирование текстур, топологии и дыр
  - Проверки места: высота, перепад, дистанции, фильтр по биому и топологии
- [x] Замена монументов
